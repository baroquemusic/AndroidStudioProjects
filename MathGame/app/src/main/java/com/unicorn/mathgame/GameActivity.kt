...
class GameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonOk.setOnClickListener {
            ...
            if (input == "") {
                Toast.makeText(applicationContext, "Please answer or click NEXT!", Toast.LENGTH_SHORT).show()
            } else {
                pauseTimer()
                ...
                if (userAnswer == correctAnswer) {
                    userScore += 10
                    textQuestion.text = "CONGRATS!!! 10 points!"
    ...
    fun gameContinue() {
        ...
        val number1 = Random.nextInt(0, 12)
        val number2 = Random.nextInt(0, 12)
